...
trait DAO {
  ...
  def countryFuzzy(query: String)(implicit ec: DAOExecutionContext): Future[Option[Country]]
...
case class CountryDef(code: String, name: String, keywords: Option[String])
